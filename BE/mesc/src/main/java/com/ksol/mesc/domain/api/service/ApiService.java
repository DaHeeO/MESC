...
public interface ApiService {
	...
	// LinkedHashMap<String, Object> getTableByQuery(String query, List<String> queryList);
	...
	// LinkedHashMap<String, Object> getTableByActionId(Integer actionId, String conditions, List<String> queryList);
